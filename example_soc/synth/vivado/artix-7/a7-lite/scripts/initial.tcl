...
set part_fpga {xc7a100tfgg484-1}
set top_module {fpga_a7_lite_2p_top}
...
set src_verilog_files [exec ../../../../../scripts/listfiles --relative -f flat fpga_a7_lite_2p_top.f]
set src_verilog_files_include_dir [exec ../../../../../scripts/listfiles --relative -f flati fpga_a7_lite_2p_top.f]
