...
set top_module {fpga_cmod_a7_top}
...
set src_verilog_files [exec ../../../../../scripts/listfiles --relative -f flat fpga_cmod_a7_top.f]
set src_verilog_files_include_dir [exec ../../../../../scripts/listfiles --relative -f flati fpga_cmod_a7_top.f]
